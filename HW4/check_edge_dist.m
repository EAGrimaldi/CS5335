...
%         free_dist -> Distance from q_start to last tick of edge that
%                      does not collide with an obstacle

function [in_collision, free_dist] = check_edge_dist(robot, q_start, q_end, link_radius, sphere_centers, sphere_radii, resolution)
    if nargin < 7
        resolution = 11;
    end
